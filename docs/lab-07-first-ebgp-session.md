...
```text
+-----------------+                    +-----------------+
| mls1-bgp-r1    |                    | mls1-bgp-r2    |
| AS 65001        |   10.1.12.0/28    | AS 65002        |
| 10.1.12.2 -----+--------------------+----- 10.1.12.3  |
|                 |                    |                 |
...
Two FRR routers run inside Docker containers connected by a bridge network. Each router belongs to a different Autonomous System and advertises one prefix via eBGP.
